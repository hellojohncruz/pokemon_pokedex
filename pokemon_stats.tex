...
\NormalTok{types\_df }\OtherTok{\textless{}{-}} 
\NormalTok{  types\_df }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{type\_2 =} \FunctionTok{if\_else}\NormalTok{(type\_2 }\SpecialCharTok{!=}\NormalTok{ type, type\_2, }\ConstantTok{NA}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
